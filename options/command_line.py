...
parser.add_argument('--wandb_project_name', type=str, default='CoSMo', help='Weights & Biases project name')
parser.add_argument('--wandb_account_name', type=str, default='f8368c1970c3428cf1a220f86b1b82d9d57881e0', help='Weights & Biases account name')
...
parser.add_argument('--root_dir', type=str, default='NO', help='Experiment description')
